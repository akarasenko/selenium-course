...
public class Task11Test {
    ...
    public void task7Test() {
        ...
        driver.findElement(By.xpath("//form[@name='customer_form']//input[@name='firstname']")).sendKeys("TestFirstName");
        ...
        driver.findElement(By.xpath("//form[@name='customer_form']//input[@name='email']")).sendKeys("test@test.com");
        ...
        driver.findElement(By.xpath("//div[@id='box-account-login']//input[@name='email']")).sendKeys("test@test.com");
