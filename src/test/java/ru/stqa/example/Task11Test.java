...
public class Task11Test {
    ...
    public void task7Test() {
        ...
        driver.findElement(By.xpath("//form[@name='customer_form']//input[@name='firstname']")).sendKeys("TestFirstName" + randomPart);
        ...
        driver.findElement(By.xpath("//form[@name='customer_form']//input[@name='email']")).sendKeys("test" + randomPart + "@test.com");
        ...
        driver.findElement(By.xpath("//div[@id='box-account-login']//input[@name='email']")).sendKeys("test" + randomPart + "@test.com");
